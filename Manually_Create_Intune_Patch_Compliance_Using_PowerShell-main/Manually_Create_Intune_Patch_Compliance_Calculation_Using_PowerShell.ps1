...
Creation Date:   15th Oct 2024
Update Date :    8th Nov 2024 (Updated Windows 24h2 information)
#>
# 
...
$DeviceList = "C:\Users\stamarapill2\Downloads\DevicesWithInventory_8f455ef6-9b6c-4dca-9f93-c3dfcb2d48d9\DevInv.csv" # Location of Intune Device data csv file
